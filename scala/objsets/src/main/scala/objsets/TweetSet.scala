...
abstract class TweetSet {
  ...
  /**
   * This method takes a predicate and returns a subset of all the elements in the original set for which the predicate is true.
   */
  ...
  /**
    * Returns true if the TweeSet is empty
    */
  def isEmpty(): Boolean
