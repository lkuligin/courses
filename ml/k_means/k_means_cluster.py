...
print 'Minimum feature: ' , min([data_dict[el]['salary'] for el in data_dict])
print 'Minimum feature: ' , max([data_dict[el]['salary'] for el in data_dict if data_dict[el]['salary'] <> 'NaN'])
